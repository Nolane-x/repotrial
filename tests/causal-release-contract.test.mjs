...
test('RepoTrial 0.7 publishes causal reasoning, active verification and benchmark capabilities', async () => {
...
test('0.7 keeps causal analysis opt-in and publishes proof-bound schemas and documentation', async () => {
  ...
  assert.equal(causal.properties.schemaVersion.const, 'repotrial.causal.v1');
